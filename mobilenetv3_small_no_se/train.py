...
Trains MobileNetV3-Small (NO SE Block) emotion recognition model.
...
def main():
	...
	logger.info("=== Emotion Recognition Model Training (Small NO SE) ===")
	...
	try:
		...
		# Create model
		logger.info("Creating model (MobileNetV3-Small NO SE)...")
