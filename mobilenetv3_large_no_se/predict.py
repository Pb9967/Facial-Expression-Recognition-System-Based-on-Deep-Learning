...
# Ciallo～(∠・ω )⌒☆
"""
Emotion recognition inference script (MobileNetV3-Large NO SE).
...
from mobilenetv3_large_no_se.utils import VisualizationHelper
...
def main():
	...
	# Print configuration
	print("=== Emotion Recognition (Large NO SE) ===")
	print("Configuration:")
