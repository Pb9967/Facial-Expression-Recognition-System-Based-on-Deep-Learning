...
Trains MobileNetV3-Large (NO SE Block) emotion recognition model.
...
def main():
	...
	logger.info("=== Emotion Recognition Model Training (Large NO SE) ===")
	...
	try:
		...
		# Create model
		logger.info("Creating model (MobileNetV3-Large NO SE)...")
